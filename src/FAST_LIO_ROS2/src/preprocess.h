...
// #include <livox_ros_driver2/msg/custom_msg.hpp> -- removed for Gazebo PointCloud2 support
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  // void process(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg, PointCloudXYZI::Ptr &pcl_out); -- removed
...
private:
  // void avia_handler(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg); -- removed
